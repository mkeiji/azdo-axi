## 1. Remove PR Agent automation

- [x] 1.1 Delete the PR Agent workflow and its workflow-specific validation script.
- [x] 1.2 Remove README guidance that describes configuring, validating, or maintaining PR Agent automation.
